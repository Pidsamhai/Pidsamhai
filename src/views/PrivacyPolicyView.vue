<template>
  <div class="tw-h-full tw-flex tw-items-center tw-justify-center">
    ...
    <div class="py-3">
      ...
      <p>
        Pidsamhai (psm) built the PIdsamhai app as a Free app. This SERVICE is
        provided by Pidsamhai (psm) at no cost and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at PIdsamhai unless otherwise
      ...
      <p>This policy is effective as of 2023-10-02</p>
      <p><strong>Contact Us</strong></p>
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at dev.psm.crop.gmail.com.
      </p>
      <p>
